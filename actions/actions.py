...
#      dispatcher.utter_message(text="iniciando conversación...")
...
class ActionServicio(Action):

  def name(self):
      return "action_servicio"

  def run(self, dispatcher, tracker, domain):        
      dispatcher.utter_message(text="iniciando servicio...")
...
class CreaVentanaBase(Action):
  ...
  def name(self):
      return "action_interfaz"

  def run(self, dispatcher, tracker, domain):        
      dispatcher.utter_message(text="crea interfaz")
      print("crea interfaz")
      ...
      imagen_nuevo = PhotoImage('Nuevo', 
                                 file='C:\\Users\\aquin\\Proyectos_SEA\\pruebas\\6-Mas\\imagenes_sea\\nuevo.png')
...
#                                  command=icomunicacion.inicia_dialogo,
      ...
      imagen_abrir = PhotoImage('Abrir', file='C:\\Users\\aquin\\Proyectos_SEA\\pruebas\\6-Mas\\imagenes_sea\\abrir.png')
...
#                                  command=Aicomunicacion.abre_dialogo,
      ...
      menu_de_dialogo.add_separator()
      imagen_guardar = PhotoImage('Guardar', file='C:\\Users\\aquin\\Proyectos_SEA\\pruebas\\6-Mas\\imagenes_sea\\guardar.png')
...
#                                  command=Aicomunicacion.guarda_dialogo,
      ...
      menu_de_dialogo.add_separator()
      imagen_salir = PhotoImage('Salir', file='C:\\Users\\aquin\\Proyectos_SEA\\pruebas\\6-Mas\\imagenes_sea\\salir.png')
...
#                                  command=Aicomunicacion.sale,
      ...
      imagen_acerca = PhotoImage('Acerca', file='C:\\Users\\aquin\\Proyectos_SEA\\pruebas\\6-Mas\\imagenes_sea\\acerca.png')
...
#                                command=Aicomunicacion.acerca
      ...
      imagen_documento = PhotoImage('Documento',
                                    file='C:\\Users\\aquin\\Proyectos_SEA\\pruebas\\6-Mas\\imagenes_sea\\documento.png')
...
#                             command=Aicomunicacion.guarda_dialogo
      ...
      imagen_dialogar = PhotoImage('dialogar',
                                   file='C:\\Users\\aquin\\Proyectos_SEA\\pruebas\\6-Mas\\imagenes_sea\\dialogar.png')
      imagen_configurar = PhotoImage('configurar',
                                     file='C:\\Users\\aquin\\Proyectos_SEA\\pruebas\\6-Mas\\imagenes_sea\\configurar.png')
